"""
Django settings for ayvblog project.
...
env = environ.Env()
env.read_env(os.path.join(BASE_DIR, os.environ.get("ENV_FILE", '.env')))
...
HTTPS_ACTIVATED = env.bool('HTTPS_ACTIVATED', default=False)
...
MIDDLEWARE = [
    ...
    'apps.middlewares.CustomLocaleMiddleware',
]
